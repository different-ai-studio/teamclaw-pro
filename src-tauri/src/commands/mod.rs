...
pub mod opencode;
#[cfg(feature = "team")]
#[path = "../../../plugins/team/src-tauri/oss_commands.rs"]
pub mod oss_commands;
#[cfg(feature = "team")]
#[path = "../../../plugins/team/src-tauri/oss_sync.rs"]
pub mod oss_sync;
#[cfg(feature = "team")]
#[path = "../../../plugins/team/src-tauri/oss_types.rs"]
pub mod oss_types;
#[cfg(feature = "team")]
#[path = "../../../plugins/team/src-tauri/p2p_state.rs"]
pub mod p2p_state;
...
pub mod stt;
#[cfg(feature = "team")]
#[path = "../../../plugins/team/src-tauri/team.rs"]
pub mod team;
#[cfg(feature = "p2p")]
#[path = "../../../plugins/team/src-tauri/team_p2p.rs"]
pub mod team_p2p;
#[cfg(feature = "team")]
#[path = "../../../plugins/team/src-tauri/team_unified.rs"]
pub mod team_unified;
#[cfg(feature = "team")]
#[path = "../../../plugins/team/src-tauri/team_webdav.rs"]
pub mod team_webdav;
pub mod updater;
#[cfg(feature = "team")]
#[path = "../../../plugins/team/src-tauri/version_commands.rs"]
pub mod version_commands;
#[cfg(feature = "team")]
#[path = "../../../plugins/team/src-tauri/version_store.rs"]
pub mod version_store;
#[cfg(feature = "team")]
#[path = "../../../plugins/team/src-tauri/version_types.rs"]
